...
if __name__ == "__main__":
    ...
    if one_or_two == "1":
        ...
        start_time: str = input("czas pojawienia się na przystanku początkowym: ")
        ...
        stops: list[str] = []
        while True:
            stop: str = input("podaj przystanek lub wciśnij enter aby zakończyć: ")
            if stop == "" or stop == "\n":
                break
            stops.append(stop)
        ...
        algorithm_a_through_stops(a, stops, optimization_criterion, start_time_obj)
